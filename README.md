...
Open the database script from:
`Database/AIUBBusManagementSystem_WithData.sql`
Execute the script to create the database and insert the demo data.
Open the project in Visual Studio.
Make sure the SQL Server connection string is configured correctly.
Run the application.
---
